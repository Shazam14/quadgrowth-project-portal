...
test.describe("CGM — /hub landing", () => {
  test("renders 11 tool cards linking to flashcards/checklists/scripts/bible/branding/pitch-coach/persona-coach/calls/reports/strategy-calls/journey", async ({ page }) => {
    await page.goto("/hub");
